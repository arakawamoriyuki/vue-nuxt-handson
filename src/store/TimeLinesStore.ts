  ...
  state: {
    timelines: [
      ...
      },
      {
        ...
        link: 'https://github.com/arakawamoriyuki/vue-nuxt-handson/blob/master/doc/web.md',
        linkText: 'github doc web',
      },
      {
        color: 'green lighten-1',
        title: 'Vue.jsについて',
        ...
        icon: 'mdi-book-open-variant',
        link: 'https://github.com/arakawamoriyuki/vue-nuxt-handson/blob/master/doc/vue.md',
        linkText: 'github doc vue',
      },
      {
        color: 'green lighten-1',
        title: '環境構築',
      ...
      },
      {
        ...
        icon: 'mdi-laptop',
        link: 'https://github.com/arakawamoriyuki/vue-nuxt-handson/blob/master/doc/hosting.md',
        linkText: 'github doc hosting',
      },
      {
        color: 'blue lighten-1',
        title: 'nuxt (optional)',
        ...
        icon: 'mdi-laptop',
        link: 'https://github.com/arakawamoriyuki/vue-nuxt-handson/blob/master/doc/nuxt.md',
        linkText: 'github doc nuxt',
      },
    ],
  },
});
